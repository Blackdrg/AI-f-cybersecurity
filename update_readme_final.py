...
# -*- coding: utf-8 -*-
"""
Direct edit: insert new sections between line 61 and 62 (after the "---" separator).
"""
...
# Insert at index 61 (after line 61 which is the "---" separator)
insert_index = 61
...
print(f"✓ Successfully inserted {new_content.count('####')} new feature sections at line {insert_index + 1}")
