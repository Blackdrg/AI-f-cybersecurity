...
- [x] 3. Edit backend/scripts/export_onnx_fixed.py: Wrap insightface/speechbrain in try/except Skip
- [x] 4. Verify with python -c exec each file
- [x] 5. pip install -r backend/requirements.txt & pytest backend/
- [x] 6. Update this TODO with ✓ completed
