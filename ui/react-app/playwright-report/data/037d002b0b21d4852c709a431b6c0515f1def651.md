...
- Name: login_clean.spec.ts >> subscription upgrade
- Location: tests\e2e\login_clean.spec.ts:12:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/subscriptions
Call log:
  - navigating to "http://localhost:3000/subscriptions", waiting until "load"
