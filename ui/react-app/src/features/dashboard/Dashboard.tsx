...
import {
  ...
  ExpandMore, ViewInAr as CubeIcon
} from '@mui/icons-material';
import Sidebar from '../../components/layout/Sidebar';
import DashboardHome from './DashboardHome';
import RecognizePage from '../recognition/Recognize';
import EnrollPage from '../enrollment/Enroll';
import AdminPanel from '../admin/AdminPanel';
import CameraManagement from '../cameras/CameraManagement';
import PersonProfile from '../enrollment/PersonProfile';
...
import { IncidentAlertDashboard } from '../incidents/IncidentAlertDashboard';
import { PermissionGuard as RBACGuard, RoleBadge } from '../../app/RBACGuard';
 ...
 const TabAnalyticsView = ({ activeTab, setActiveTab }: { activeTab: number; setActiveTab: (tab: number) => void }) => (
  ...
  const DashboardIntelligencePanelWrapped = () => {
    const DashboardIntelligencePanel = React.lazy(() => 
      import('./DashboardIntelligencePanel').catch(() => ({ default: () => <Box>Component unavailable</Box> }))
    );
    return (
