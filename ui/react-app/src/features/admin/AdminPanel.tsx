...
const OperatorWorkflowPanel = React.lazy(() => 
  import('../dashboard/OperatorWorkflowPanel').catch(() => ({ default: () => <Box>Component unavailable</Box> }))
);
const ExplainableAIPanel = React.lazy(() => 
  import('../ai-assistant/ExplainableAIPanel').catch(() => ({ default: () => <Box>Component unavailable</Box> }))
);
const DashboardIntelligencePanel = React.lazy(() => 
  import('../dashboard/DashboardIntelligencePanel').catch(() => ({ default: () => <Box>Component unavailable</Box> }))
);
const EnrichmentPortalPanel = React.lazy(() => 
  import('../dashboard/EnrichmentPortalPanel').catch(() => ({ default: () => <Box>Component unavailable</Box> }))
);
